...
//FORMATAÇÃO
//CORRENTE DO MOTOR / CORRENTE DAS BATERIAS / TEMPERATURA / HUMIDADE / TENSAO DE ALIMENTAÇÃO DA PCB / ESTADO DA ARRAY SOLAR 1 / ESTADO ARRAY SOLAR 2
...
void loop()
{
  ...
  if (currentmillis - previousmillis >= 1000)
  {
    ...
    float voltage_alimentation = x;
    //float motor_current = get_motor_current();
    float motor_current = y;
    float battery_current = z;
